...
def linear_programming(pm):
    ...
    # Fiona's Strategy
    c = [0, 0, 0, 1]
    # A_ub = [[pm[0][0][1], pm[2][0][1], pm[1][0][1], -1], 
    #         [pm[0][2][1], pm[2][2][1], pm[1][2][1], -1], 
    #         [pm[0][1][1], pm[2][1][1], pm[1][1][1], -1]]
    A_ub = [[pm[0][0][1], pm[1][0][1], pm[2][0][1], -1], 
            [pm[0][1][1], pm[1][1][1], pm[2][1][1], -1], 
            [pm[0][2][1], pm[1][2][1], pm[2][2][1], -1]]
    # A_ub = [[2, 11, 3, -1], [3, 6, 4, -1], [4, 2, -4, -1]]
    b_ub = [0, 0, 0]
    A_eq = [[1, 1, 1, 0]]
    b_eq = [1]
    fr_bounds = (0, None)
    ...
    f_vals = linprog(c, 
                    A_ub=A_ub, b_ub=b_ub, 
                    A_eq=A_eq, b_eq=b_eq, 
                    bounds=[fr_bounds, fg_bounds, fb_bounds, V_bounds]).x

    # Paul's Strategy
    c = [0, 0, 0, -1]
    # A_ub = [[pm[0][0][1], pm[0][1][1], pm[0][2][1], 1], 
    #         [pm[1][0][1], pm[1][1][1], pm[1][2][1], 1], 
    #         [pm[2][0][1], pm[2][1][1], pm[2][2][1], 1]]
    A_ub = [[-pm[0][0][1], -pm[0][1][1], -pm[0][2][1], 1], 
            [-pm[1][0][1], -pm[1][1][1], -pm[1][2][1], 1], 
            [-pm[2][0][1], -pm[2][1][1], -pm[2][2][1], 1]]
    # A_ub = [[-2, -3, -4, 1], [-11, -6, -2, 1], [-3, -4, 4, 1]]
    b_ub = [0, 0, 0]
    A_eq = [[1, 1, 1, 0]]
    b_eq = [1]
    fr_bounds = (0, None)
